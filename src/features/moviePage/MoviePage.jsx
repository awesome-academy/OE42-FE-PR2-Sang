            ...
            <div key={movie._id} className="main__moviePage__movieList-item">
                ...
                <div className="main__moviePage__movieList-item--info">
                    ...
                    <div className="order-btn">
                        <Link to="/" style ={{display: status==="coming" ? "none" : "flex"}}>
        ...
        <main className="main__moviePage">
            <Container>
                ...
                <div className="main__moviePage__search">
                    <form className = "main__moviePage__search__form" onSubmit={(event) => handleSubmit(event)}>
                        <input 
                            type="text"
                ...
                <div className="main__moviePage__movieList">
                    {movieItem}
                </div>
            </Container>
        </main>
